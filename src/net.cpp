...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Houseofcoins " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"houseofcoinstools.com", "dnsseed.houseofcoinstools.com"},
    {"houseofcoinspool.org", "dnsseed.houseofcoinspool.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"houseofcoinstools.com", "testnet-seed.houseofcoinstools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Houseofcoins is probably already running."), addrBind.ToString().c_str());
        else
